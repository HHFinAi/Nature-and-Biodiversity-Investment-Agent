...
|---|---:|---|
| `listed-equity` | 14 | equity |
| `public-credit` | 14 | bond |
| `private-nature-project` | 14 | private_project |
| `portfolio-screen` | 14 | equity, bond, portfolio |
| `nature-credit` | 14 | biodiversity_credit, private_project |
...
```bash
python3 -m sf_agent calc --operation nature_cashflow_stress --arguments examples/calculation-arguments.json --currency USD
```

# Actual validation — Nature and Biodiversity Investment Agent

**Build:** v0.1.0 · **Date:** September 24, 2026 · **Local environment:** Python 3.13.5 on Linux.

| Check actually performed | Result |
|---|---|
| Local unittest suite | **108 tests passed; 0 failures; 0 errors** |
...
| JSON Schema definitions and bundled examples | Validated; 16 exported stage artifacts checked |
